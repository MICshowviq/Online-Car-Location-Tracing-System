...
#define WIFISSID "Virus" // Put here your Wi-Fi SSID
#define PASSWORD "agertaiase" // Put here your Wi-Fi password
#define TOKEN  "BBFF-Wm5a4y1UiZ2KveQmL9mmnvkAQlrxUv"  // Put here your Ubidots TOKEN
...
void setup()
{
  ...
  client.wifiConnect(WIFISSID, PASSWORD);      // Connect to the wifi router.
}
